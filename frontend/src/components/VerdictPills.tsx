      ...
      {PILLS.map((pill) => {
        ...
        return (
          <motion.button
            ...
            className={`rounded-full border px-4 py-2 font-mono text-xs uppercase tracking-widest outline-none transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-hazard focus-visible:ring-offset-2 focus-visible:ring-offset-void ${
